package Books::Controller::User;
use Moose;
use namespace::autoclean;

use Books::Form::ChangePassword ();
use Books::Form::UserProfile    ();
use Books::Form::AddUser    ();
use Books::Form::EditUser    ();
...
sub add : Chained('admin') PathPart('add') Args(0) {
    ...
    my $form = Books::Form::AddUser->new;
...
sub edit : Chained('user') PathPart('edit') Args(0) {
    ...
    my $form = Books::Form::EditUser->new;
...
sub profile : Chained('base') PathPart('profile') Args(0) {
    ...
    my $form = Books::Form::UserProfile->new;
...
sub change_password : Chained('base') PathPart('change_password') Args(0) {
    ...
    my $form = Books::Form::ChangePassword->new;
